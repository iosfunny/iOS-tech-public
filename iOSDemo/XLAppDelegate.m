...
{
    [[XLAppInitProcess sharedInstance] application:application beforeFinishLaunchingWithOptions:launchOptions];
    UIViewController * rootVC = [[XLAppInitProcess sharedInstance] makeRootViewControllerWithLaunchOptions:launchOptions];
